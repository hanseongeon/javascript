...
문자열
 - string 타입이라고 합니다.
 - 문자열을 표현할 땐 작은따음표('), 큰따옴표(""), 백틱(`) 사용
 - 백틱(`)은 ES6버전에서 도입되었다.

백틱
 - 여러줄 표현이 가능하다.
 - 템플릿 문자열을 더 편리하게 사용이 가능하다.
 - 백틱에서 변수를 사용할려면 ${변수명} 을 사용한다.
...
let nameD = "한성언";
let age = 25;
console.log("내이름은 "+nameD+"입니다 "+"나이는 "+age+"살입니다");
//백틱 사용
console.log(`내 이름은 ${nameD} 입니다. 나이는 ${age}살 입니다.`);
...
console.log(key1); // 심볼까지 출력된다.
console.log(key1.description); // 심볼값 출력 (심볼은 빠지고)
